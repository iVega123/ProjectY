...
$rabbitMqPermissions = @(
    ...
    [ordered]@{ user = $values.RIDER_MANAGER_RABBITMQ_USER; vhost = "projecty-rider"; configure = "^(rider_info_queue|image_stream_queue|rider_info_poison_queue|RiderInfoPoisonQueue|retry-poison-[0-9]+)$"; write = "^(amq\.default|rider_info_queue|image_stream_queue|rider_info_poison_queue|RiderInfoPoisonQueue|retry-poison-[0-9]+)$"; read = "^(rider_info_queue|image_stream_queue|rider_info_poison_queue|RiderInfoPoisonQueue|retry-poison-[0-9]+)$" },
    ...
    [ordered]@{ user = $values.RENTAL_OPERATIONS_RABBITMQ_USER; vhost = "projecty-rental"; configure = "^(licence_update_queue|licence_update_poison_queue|retry-poison-[0-9]+)$"; write = "^(amq\.default|licence_update_queue|licence_update_poison_queue|retry-poison-[0-9]+)$"; read = "^(licence_update_queue|licence_update_poison_queue|retry-poison-[0-9]+)$" },
