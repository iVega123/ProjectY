...
| [0026](0026-redis-durability-follows-the-consumer.md) | Redis durability follows the consumer | Why the rate limiter has its own Redis, and what the one-second window costs idempotency |
